...
struct TargetDesc2D
{
    ...
    //! @brief      引数付きコンストラクタです.
    //---------------------------------------------------------------------------------------------
    TargetDesc2D(UINT w, UINT h, DXGI_FORMAT format)
    : Width         (w)
    , Height        (h)
    , Format        (format)
    , MipLevels     (1)
...
public:
    ...
    //---------------------------------------------------------------------------------------------
    bool Resize(ID3D11Device* pDevice, uint32_t width, uint32_t height);
...
private:
    ...
    // private methods.
    //=============================================================================================
    ColorTarget2D             (const ColorTarget2D&) = delete;
    ColorTarget2D& operator = (const ColorTarget2D&) = delete;
};
...
public:
    ...
    //! @retval false   リサイズに失敗.
    //---------------------------------------------------------------------------------------------
    bool Resize(ID3D11Device* pDevice, uint32_t width, uint32_t height, uint32_t depth);
...
private:
    ...
    // private methods.
    //=============================================================================================
    ColorTarget3D               (const ColorTarget3D&) = delete;
    ColorTarget3D& operator =   (const ColorTarget3D&) = delete;
};
...
private:
    ...
    // private methods.
    //=============================================================================================
    DepthTarget2D               (const DepthTarget2D&) = delete;
    DepthTarget2D& operator =   (const DepthTarget2D&) = delete;
};
